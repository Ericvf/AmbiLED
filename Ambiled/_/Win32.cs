...
{
    public class Win32HandleHighlighter
    {
        public static void Highlight(IntPtr hWnd)
        {
            ...
            if (hDC != IntPtr.Zero)
            {
                using (var pen = new System.Drawing.Pen(System.Drawing.Color.Red, penWidth))
                {
        ...
        public static void Refresh(IntPtr hWnd)
        {
            ...
            User32.RedrawWindow(hWnd, IntPtr.Zero, IntPtr.Zero, Win32.RDW_FRAME | Win32.RDW_INVALIDATE | Win32.RDW_UPDATENOW | Win32.RDW_ALLCHILDREN);
        }
    }
